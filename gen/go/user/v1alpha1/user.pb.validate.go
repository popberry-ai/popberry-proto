...
func (m *User) validate(all bool) error {
	...
	// no validation rules for Lineid

	// no validation rules for Banknumber
	...
	// no validation rules for BankCategoriesId

	// no validation rules for WaysId

	// no validation rules for WalletsId

	// no validation rules for Role

	// no validation rules for LineUserId
...
func (m *Wallet) validate(all bool) error {
	...
	// no validation rules for UserPromotionId

	// no validation rules for DepositTurnover

	// no validation rules for DepositTurnoverCounter
