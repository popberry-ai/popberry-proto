...
const (
	...
	UserService_GetUser_FullMethodName    = "/user.v1alpha1.UserService/GetUser"
	UserService_UpdateUser_FullMethodName = "/user.v1alpha1.UserService/UpdateUser"
	UserService_DeleteUser_FullMethodName = "/user.v1alpha1.UserService/DeleteUser"
	UserService_ListUsers_FullMethodName  = "/user.v1alpha1.UserService/ListUsers"
)
